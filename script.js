...
let scores = {};
let userAnswers = [];
const ORDER_FORM_URL = "https://tally.so/r/XxydXe";
...
const quizData = {
  ...
  zh: {
    questions: [
      ...
      {
        text: "如果喜欢的“ta”约你吃饭，和朋友开黑，参加event和兼职赚钱哪一项对你来说最重要？",
        options: [
      ...
      {
        text: "NTU的orientation你会干嘛？",
        options: [
          { text: "有这功夫不如预习一下课本", type: "pypfinder" },
          { text: "把自己关在宿舍生人勿近", type: "hallhermit" },
